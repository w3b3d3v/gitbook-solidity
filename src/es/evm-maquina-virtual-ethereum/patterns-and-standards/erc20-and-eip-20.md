...
---
::: tip
  EIP son estándares de implementación con el consenso de la comunidad y los mineros para implementar cambios de comportamiento en la Máquina Virtual Ethereum. Ya el ERC se refiere a estándares para Smart Contracts.
:::
